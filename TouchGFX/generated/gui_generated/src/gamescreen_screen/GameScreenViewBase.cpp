...
GameScreenViewBase::GameScreenViewBase()
{
    ...
    ball.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    add(ball);

    a_position.setPosition(49, 208, 92, 25);
    a_position.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    a_position.setLinespacing(0);
    a_positionBuffer[0] = 0;
    a_position.setWildcard(a_positionBuffer);
    a_position.setTypedText(touchgfx::TypedText(T___SINGLEUSE_BFAF));
    a_position.setVisible(false);
    add(a_position);

    b_position.setPosition(175, 208, 92, 25);
    b_position.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    b_position.setLinespacing(0);
    b_positionBuffer[0] = 0;
    b_position.setWildcard(b_positionBuffer);
    b_position.setTypedText(touchgfx::TypedText(T___SINGLEUSE_34W8));
    b_position.setVisible(false);
    add(b_position);

    paddleA.setPosition(15, 95, 15, 50);
    paddleAPainter.setColor(touchgfx::Color::getColorFromRGB(15, 102, 240));
    ...
    paddleBPainter.setColor(touchgfx::Color::getColorFromRGB(219, 19, 19));
    ...
    placarA.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    placarA.setLinespacing(0);
    Unicode::snprintf(placarABuffer, PLACARA_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_ZWZF).getText());
    placarA.setWildcard(placarABuffer);
    placarA.setTypedText(touchgfx::TypedText(T___SINGLEUSE_VE86));
    add(placarA);

    placarB.setPosition(175, 8, 40, 24);
    placarB.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    placarB.setLinespacing(0);
    Unicode::snprintf(placarBBuffer, PLACARB_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_OUZH).getText());
    placarB.setWildcard(placarBBuffer);
    placarB.setTypedText(touchgfx::TypedText(T___SINGLEUSE_7HFN));
    add(placarB);

    textPlacar.setPosition(141, 8, 34, 24);
    textPlacar.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textPlacar.setLinespacing(0);
    textPlacar.setTypedText(touchgfx::TypedText(T___SINGLEUSE_VU52));
    add(textPlacar);
}
