...
/********** ST7789 LCD driver Private Functions Prototypes ***********************/
// static void st7789_write_command(uint8_t command);
// static void st7789_write_data(uint8_t *data, uint8_t len);

// /** These functions should be macros :( */
// static void _DC_COMMAND(void);
// static void _DC_DATA(void);
// static void _CS_ACTIVE(void);
// static void _CS_IDLE(void);
// static void _RESX_ACTIVE(void);
// static void _RESX_IDLE(void);
...
void st7789_Init(void) {
    ...
    //! Testar sem esses comandos todos ou sem a linha 136 apenas
...
//     _DC_COMMAND();
//     _CS_ACTIVE();
//     HAL_SPI_Transmit(ST7789V_drv.spi_handle, &command, 1, 500);
//     _CS_IDLE();
// }

// void st7789_write_data(uint8_t *data, uint8_t len) {
//     if (len > 0) {
//         _DC_DATA();
//         _CS_ACTIVE();
//         HAL_SPI_Transmit(ST7789V_drv.spi_handle, data, len, 500);
//     }
...
// static void _DC_COMMAND(void) {
//     HAL_GPIO_WritePin(ST7789V_drv.DC_port, ST7789V_drv.DC_pin, GPIO_PIN_RESET);
// }

// static void _DC_DATA(void) {
//     HAL_GPIO_WritePin(ST7789V_drv.DC_port, ST7789V_drv.DC_pin, GPIO_PIN_SET);
// }

// static void _CS_ACTIVE(void) {
//     HAL_GPIO_WritePin(ST7789V_drv.CS_port, ST7789V_drv.CS_pin, GPIO_PIN_RESET);
// }

// static void _CS_IDLE(void) {
//     HAL_GPIO_WritePin(ST7789V_drv.CS_port, ST7789V_drv.CS_pin, GPIO_PIN_SET);
// }

// static void _RESX_ACTIVE(void) {
//     HAL_GPIO_WritePin(ST7789V_drv.RESX_port, ST7789V_drv.RESX_pin, GPIO_PIN_RESET);
// }

// static void _RESX_IDLE(void) {
//     HAL_GPIO_WritePin(ST7789V_drv.RESX_port, ST7789V_drv.RESX_pin, GPIO_PIN_SET);
// }